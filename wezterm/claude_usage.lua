...
if [ -n "$TOKEN" ]; then
  curl -s -H "Authorization: Bearer $TOKEN" -H "anthropic-beta: oauth-2025-04-20" -H "User-Agent: claude-code/2.1.70" -H "Accept: application/json" "https://api.anthropic.com/api/oauth/usage" 2>/dev/null
